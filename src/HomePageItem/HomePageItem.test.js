...
describe("HomePageItem tests", () => {
    const article = {
        "id": "001",
        "title": "Coinbase Makes Its Debut—and Bitcoin Arrives on Wall Street",
        "shortText": "The big cryptocurrency exchange goes public through a direct listing, and it could make a bigger debut than Facebook.",
    ...
    it("rendered correctly", () => {  
        const { container } = render(<HomePageItem article={article}/>);
